...
\begin{minipage}[t]{\textwidth}
	...
	\begin{minipage}[t]{0.6\textwidth}
		...
		\tikz[na] \node[scale=0.5,coordinate,fill=blue!20,draw,circle] (n1) {};		    
		   		 \onslide<2->{Vector bun. $E=TM\oplus (\wedge^{n-1}T^\ast M)$;}
		\\
		\tikz[na]\node [scale=0.5,coordinate,fill=green!20,draw,circle] (n2) {};	    
		    		\onslide<3->{anchor map 
	...
	\begin{minipage}[t]{\textwidth}
		...
		\onslide<5->{(higher) Courant bracket 
			\begin{displaymath}
				\begin{tikzcd}[ampersand replacement=\&]
					\lbrack\cdot,\cdot\rbrack_\omega~:\&[-3em] \Gamma(E)\otimes \Gamma(E) \ar[r]\& \Omega^{n-2}(M)
					\\[-2em]
					\& \binom{x_1}{\alpha_1}\otimes\binom{x_2}{\alpha_2} \ar[r,mapsto]				
					\& \binom{[x_1,x_2]}{
...
\begin{tikzpicture}[overlay]
        ...
        \onslide<3->{\path[->,opacity=0.3] (n2) edge [bend left] (t2);}
        \onslide<4->{\path[->,opacity=0.3] (n3) edge [bend left] (t3.south);}
        \onslide<5->{\path[->,opacity=0.3] (n4) edge [bend left] (t4.south);}
