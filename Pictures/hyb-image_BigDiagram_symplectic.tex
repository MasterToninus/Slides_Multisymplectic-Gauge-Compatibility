...
%
		...
		\ar[dr,visible on=<3->,sloped,"\text{Preq}_\theta",xshift=.5em]	
...
%
		...
		&
		|[visible on=<3->]| Q(P,\theta) 
		\ar[ur,visible on=<3->,hook] 
		\ar[dr,visible on=<3->,hook]
		\ar[r,visible on=<3->,phantom,blue,"\circlearrowright"]
		& \phantom.
		&
%
	\\
%
		...
		\ar[rr,visible on=<1->,"\Psi"]
		\ar[ur,visible on=<3->,sloped,"\text{Preq}_\theta"',xshift=.5em]		
		& 
		&
