...
\begin{minipage}[t]{\textwidth}
	...
	\begin{minipage}[t]{0.6\textwidth}
		...
		\tikz[na] \node[scale=0.5,coordinate,fill=blue!20,draw,circle] (n1) {};		    
		   		 Vector bun. $E=TM\oplus (\wedge^{n-1}T^\ast M)$;
		\\
					...
					\begin{displaymath}
						\begin{tikzcd}
							...
							& \binom{[x_1,x_2]}{
								...
								d\left\langle \binom{x_1}{\alpha_1},\binom{x_2}{\alpha_2} \right \rangle +
...
\begin{tikzpicture}[overlay]
        ...
        \path[->] (n3) edge [bend left] (t3.south);
        \path[->] (n4) edge [bend left] (t4.south);
