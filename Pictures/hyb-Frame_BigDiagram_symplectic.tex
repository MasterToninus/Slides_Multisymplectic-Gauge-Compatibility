...
%		}
		...
		\ar[drr,grey,visible on=<2-4>,rightsquigarrow,"\text{observables}",shift right=.5em]
		\ar[rrrrr,grey,visible on=<2-4>,rightsquigarrow,"\text{twisted standard Lie algebroid}"]
		\ar[dddd,grey,visible on=<2-4>,rightsquigarrow,sloped,"\text{gauge transf.}"']
		&[-1.5em] &[-1em] & & 
		&[-4em] |[visible on=<2-4>]|\color{grey}(TM \oplus \mathbb{R},\rho, [\cdot,\cdot]_\omega)
		\ar[dl,grey,visible on=<2-4>,rightsquigarrow]
...
%
		...
		&
		& |[visible on=<2->]|\big(\Gamma(TM\oplus \mathbb{R}),[\cdot,\cdot]_\omega\big)
...
%		
	\\[.5em]
%	
		|[visible on=<1-4>]|\color{grey}(M,\tilde{\omega}) 
