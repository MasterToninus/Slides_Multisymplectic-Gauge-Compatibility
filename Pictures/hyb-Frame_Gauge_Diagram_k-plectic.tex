...
\begin{document}
	\begin{tikzcd}[
		...
		\ar[dddd,grey,visible on=<1>,sloped,"\cong","\text{B-transf.}"']
%
	\\
%
		& \phantom{\big(}
		& |[visible on=<1->,alias=A1]| L_{\infty}(M,\omega)
		\ar[r,visible on=<2->,line width=0.8pt,color=blue!60!black,"\Psi"]
		\ar[ddr,visible on=<4->,phantom,blue,"\circlearrowright"]
		& |[visible on=<1->]| L_{\infty}\big(E^n,\omega\big)
		\ar[dd,sloped,"\cong", visible on=<2->]
		&
%		 
	\\
%
		&|[visible on=<3->,alias=A2]|\mathfrak{g} \ar[ur,visible on=<3->]\ar[dr,visible on=<3->]& & & 
%
	\\
%
