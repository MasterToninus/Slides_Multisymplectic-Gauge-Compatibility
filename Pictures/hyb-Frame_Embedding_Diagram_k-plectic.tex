...
\begin{document}
	\begin{tikzcd}[column sep= small,row sep=small,
		...
		|[visible on=<1-3>]|(M,\omega) 
		\ar[dr,visible on=<1-3>,rightsquigarrow,"\text{observables}"]
		\ar[rrr,visible on=<2-3>,rightsquigarrow,"\text{twisted standard Vinogradov algebroid}"]
		& &[4em] &[-3em] 
		|[visible on=<2-3>]| (E^n,\rho,\langle\cdot,\cdot\rangle,[\cdot,\cdot]_\omega)
...
%
		...
		\ar[r,visible on=<5->,dashed,hook,line width=0.8pt,color=blue!60!black,"\Psi"]
